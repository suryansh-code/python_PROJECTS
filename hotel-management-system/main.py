...
#-----------splash_screen------------------------------------------------------------------------------------------------------------------
sroot = Tk()
sroot.minsize(height=716,width=1300)
...
#chilanka
Label(sroot,text="BHAWANI GUEST HOUSE ",font='Timesnewroman 40 ',bg='white',fg='black').place(x=535,y=10)
Label(sroot,text="Made by -",font='Timesnewroman 40 ',bg='white',fg='black').place(x=535,y=90)
Label(sroot,text="Suryansh/Kuldeep",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
...
def mainroot():
	...
	tf_label = Label(top_frame,text='BHAWANI GUEST HOUSE',font='msserif 33',fg='black',bg='gray89',height=70)
	...
	#cur.execute("create table if not exists paymentsf(id number  primary key,f_name varchar,l_name varchar,c_number varchar,email varchar , r_n number ,day varchar,month varchar,year varchar,time varchar , method varchar)")
		...
		nl = Label(b_frame,text='Made by suryansh/kuldeep',fg='black',bg='gray91',font='msserif 8')
		nl.place(x=955,y=310)
		nl.tkraise()
	#-------------login module----------------------------------------------------------------------------------------------------------------------
	def login():
